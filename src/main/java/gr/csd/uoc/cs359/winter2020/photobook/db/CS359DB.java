...
public class CS359DB {
    ...
    private static final String UNAME = "csd3272"; // Share your repo to give you the credentials
    private static final String PASSWD = "jVBKn@a4";  // Share your repo to give you the credentials
